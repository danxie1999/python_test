...
if __name__ == '__main__':
	...
	password=base64.decodestring(STRQQ).decode('utf-8')
	...
	OMnu=int(last_line('C:\python_test\mail_test\mail_count_qq.txt'))
	if Mnu > OMnu:
		New_Mnu=Mnu - OMnu
		...
		with open('C:\python_test\mail_test\mail_count_qq.txt','a') as f:
			f.write("\n{}".format(Mnu))
	elif Mnu == OMnu:
